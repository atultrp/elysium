...
// import crtABI from "@/data/crtABI.json";
...
// Get Token Balance
// export const getBalance = async (usdtAddress, CRTAddress, mdtxAddress, slpAddress, xrpAddress, dogeAddress, axsAddress, manaAddress, shibAddress) => {
//   try {
//     await window.ethereum.request({ method: 'eth_requestAccounts' });
//     const web3 = new Web3(window.ethereum);
//     const accountResponse = await web3.eth.getAccounts();
//     const userAdd = accountResponse[0];
//     let usdtTotalBalance, crtTotalBalance, claimTotalBalance, mdtx, slp, xrp, doge, mana, axs, shib
...
//     // CRT Balance
//     if (CRTAddress) {
//       const crtContract = new web3.eth.Contract(crtABI, CRTAddress);
//       const crtBalance = await crtContract.methods.balanceOf(userAdd).call();
//       let crtBalanceString = crtBalance.toString();
//       let crtBalanceNumber = Number(crtBalanceString);
//       crtTotalBalance = (crtBalanceNumber / 1e8).toFixed(2);
//     }

//     // MDTX Balance
//     if (mdtxAddress) {
//       const mdtxContract = new web3.eth.Contract(crtABI, mdtxAddress);
...
//     // SLP Balance
//     if (slpAddress) {
//       const slpContract = new web3.eth.Contract(crtABI, slpAddress);
...
//     // XRP Balance
//     if (xrpAddress) {
//       const xrpContract = new web3.eth.Contract(crtABI, xrpAddress);
...
//     // DOGE Balance
//     if (dogeAddress) {
//       const dogeContract = new web3.eth.Contract(crtABI, dogeAddress);
...
//     // MANA Balance
//     if (manaAddress) {
//       const manaContract = new web3.eth.Contract(crtABI, manaAddress);
...
//     // AXS Balance
//     if (axsAddress) {
//       const axsContract = new web3.eth.Contract(crtABI, axsAddress);
...
//     // SHIB Balance
//     if (shibAddress) {
//       const shibContract = new web3.eth.Contract(crtABI, shibAddress);
...
//     return { usdtTotalBalance, crtTotalBalance, mdtx, slp, xrp, doge, mana, axs, shib}
...
//     const accountResponse = await web3.eth.getAccounts();
//     const userAdd = accountResponse[0];
//     const contractUsdt = new web3.eth.Contract(crtABI, usdtAdd);
//     const contractMdtx = new web3.eth.Contract(crtABI, tokenAdd);
